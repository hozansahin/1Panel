...
const message = {
    commons: {
        ...
        button: {
            ...
            get: 'Al',
            upgrade: 'Yükselt',
            ignore: 'Yükseltmeyi görmezden gel',
            copy: 'Kopyala',
            random: 'Rastgele',
            uninstall: 'Kaldır',
        ...
        table: {
            ...
            refreshRateUnit: 'Yenileme yok | {n} saniye/kez | {n} saniye/kez',
        ...
        loadingText: {
            ...
            Recovering: 'Anlık görüntüden geri yükleniyor, lütfen bekleyin...',
        ...
        msg: {
            ...
            operatorHelper: '"{0}" üzerinde "{1}" işlemi gerçekleştirilecek ve geri alınamayacak. Devam etmek istiyor musunuz?',
            notFound: 'Üzgünüz, istediğiniz sayfa mevcut değil.',
            unSupportType: 'Dosya türü desteklenmiyor.',
            unSupportSize: 'Yüklenen dosya {0}M\'yi aşıyor, lütfen kontrol edin!',
            fileExist: 'Dosya mevcut klasörde zaten var. Tekrar yükleme desteklenmiyor.',
            fileNameErr:
                'Yalnızca adı 1-256 karakter olan (İngilizce, Çince, rakamlar veya .-_ içeren) dosyaları yükleyebilirsiniz',
            confirmNoNull: '{0} değerinin boş olmadığından emin olun.',
            errPort: 'Yanlış port bilgisi, lütfen kontrol edin!',
            remove: 'Kaldır',
            backupHelper: 'Bu işlem {0} yedekleyecek. Devam etmek istiyor musunuz?',
            ...
            rootInfoErr: 'Zaten kök dizin',
            resetSuccess: 'Sıfırlama başarılı',
            creatingInfo: 'Oluşturuluyor, bu işleme gerek yok',
        },
        login: {
            username: 'Kullanıcı adı',
            password: 'Şifre',
            welcome: 'Tekrar hoş geldiniz, lütfen giriş için kullanıcı adınızı ve şifrenizi girin!',
            errorAuthInfo: 'Girdiğiniz kullanıcı adı veya şifre yanlış, lütfen tekrar girin!',
            errorMfaInfo: 'Doğrulama bilgileri hatalı, lütfen tekrar deneyin!',
            captchaHelper: 'Captcha',
            errorCaptcha: 'Captcha kodu hatalı!',
            notSafe: 'Erişim reddedildi',
            safeEntrance1: 'Güvenli giriş mevcut ortamda etkinleştirildi',
            safeEntrance2: 'Panel girişini görmek için SSH terminalinde şu komutu girin: 1pctl user-info',
            errIP1: 'Yetkili IP adresi erişimi mevcut ortamda etkin',
            errDomain1: 'Erişim alan adı bağlama mevcut ortamda etkin',
            errHelper: 'Bağlama bilgisini sıfırlamak için SSH terminalinde şu komutu çalıştırın: ',
            codeInput: 'MFA doğrulayıcısının 6 haneli doğrulama kodunu girin',
            mfaTitle: 'MFA Doğrulaması',
            mfaCode: 'MFA doğrulama kodu',
            title: 'Linux Sunucu Yönetim Paneli',
            licenseHelper:
                '&laquo; <a href="https://www.fit2cloud.com/legal/licenses.html" target="_blank">Topluluk Lisans Sözleşmesi</a> &raquo;\'ni kabul et',
            errorAgree: 'Topluluk Yazılım Lisansını kabul etmek için tıklayın',
            logout: 'Çıkış',
            agreeTitle: 'Sözleşme',
            agreeContent:
                'Yasal haklarınızı daha iyi korumak için lütfen aşağıdaki &laquo; <a href = "https://www.fit2cloud.com/legal/licenses.html" target = "_blank" > Topluluk Lisans Sözleşmesi </a> &raquo;ni okuyup kabul edin',
        },
        rule: {
            username: 'Bir kullanıcı adı girin',
            password: 'Bir şifre girin',
            rePassword: 'Şifre onayı şifre ile uyuşmuyor.',
            requiredInput: 'Bu alan gereklidir.',
            requiredSelect: 'Listeden bir öğe seçin',
            illegalChar: 'Şu anda &, ;, $, \\`, ( ), " > < | karakterlerinin eklenmesi desteklenmiyor',
            illegalInput: 'Bu alan yasadışı karakterler içermemelidir.',
            commonName:
                'Bu alan özel olmayan bir karakterle başlamalı ve İngilizce, Çince, rakamlar, ".", "-" ve "_" karakterlerinden oluşmalı (1-128).',
            userName: 'Bu alan İngilizce, Çince, rakamlar ve "_" karakterlerinden oluşmalı, uzunluğu 3-30 olmalı.',
            simpleName: 'Bu alan alt çizgi ile başlamamalı ve İngilizce harfler, rakamlar ve "_" karakterlerinden oluşmalı, uzunluğu 3-30 olmalı.',
            simplePassword: 'Bu alan alt çizgi ile başlamamalı ve İngilizce harfler, rakamlar ve "_" karakterlerinden oluşmalı, uzunluğu 1-30 olmalı.',
